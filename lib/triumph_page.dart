          ...
          children: [
                ...
                child: SizedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(
                          height:
                              MyAdaptiveDimension.verticalSpaceGap(context)),
                      InkWell(
                        borderRadius: BorderRadius.circular(50),
                        onTap: () {
                          // Navigator.pop(context);
            ...
            AnimatedPositioned(
              ...
              height: (isAbleToAddVictory)
                  ? MyAdaptiveDimension.getHeight(context) * .70
                  : 0,
                        ...
                        child: Column(
                          children: [
                            ...
                            (isAbleToAddVictory)
                                ? Container(
                                    width:
                                        MyAdaptiveDimension.getWidth(context) *
                                            .80,
                                    height:
                            ...
                            SizedBox(
                              height:
                                  MyAdaptiveDimension.getHeight(context) * .091,
                            ),
                            Row(
                            ...
                            SizedBox(
                              height:
                                  MyAdaptiveDimension.getHeight(context) * .1,
                            ),
                          ],
                        ),
                      )
